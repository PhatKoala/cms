 ...
 */
final class Version20200309230734 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post_type_taxonomy_type ADD CONSTRAINT FK_DC55BAA9EE3CD59E FOREIGN KEY (taxonomy_type) REFERENCES taxonomy_type (type)');
