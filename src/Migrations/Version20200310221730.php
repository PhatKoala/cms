 ...
 */
final class Version20200310221730 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE term (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(100) DEFAULT NULL, tree_root INT DEFAULT NULL, parent_id INT DEFAULT NULL, status VARCHAR(64) NOT NULL, title VARCHAR(255) DEFAULT NULL, content LONGTEXT DEFAULT NULL, position INT NOT NULL, slug VARCHAR(128) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, lft INT NOT NULL, lvl INT NOT NULL, rgt INT NOT NULL, UNIQUE INDEX UNIQ_A50FE78D989D9B62 (slug), INDEX IDX_A50FE78D8CDE5729 (type), INDEX IDX_A50FE78DA977936C (tree_root), INDEX IDX_A50FE78D727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_type_demographic_type ADD CONSTRAINT FK_45D69026D24D5CE9 FOREIGN KEY (demographic_type) REFERENCES demographic_type (type)');
    }
